    ...
    module
        ...
        .expect_grpc_call(
            ...
            Some(&[
              ...
              14, 0, 0, 0,                                                          // value length = 14
              58, 97, 117, 116, 104, 111, 114, 105, 116, 121, 0,                    // ":authority" + NUL
              100, 111, 101, 115, 45, 110, 111, 116, 45, 101, 120, 105, 115, 116, 0 // "does-not-exist" + NUL
            ]),
            Some(&[
...
fn it_fails_on_second_action_grpc_call() {
    ...
    module
        ...
        .expect_grpc_call(
            ...
            Some("envoy.service.ratelimit.v3.RateLimitService"),
            Some("ShouldRateLimit"),
            Some(&[1, 0, 0, 0, 10, 0, 0, 0, 14, 0, 0, 0, 58, 97, 117, 116, 104, 111, 114, 105, 116, 121, 0, 100, 111, 101, 115, 45, 110, 111, 116, 45, 101, 120, 105, 115, 116, 0]),
            Some(&[
                10, 1, 97, 18, 28, 10, 26, 10, 21, 108, 105, 109, 105, 116, 95, 116, 111, 95, 98,
                101, 95, 97, 99, 116, 105, 118, 97, 116, 101, 100, 18, 1, 49, 24, 1,
            ]),
