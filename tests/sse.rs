...
#[test]
#[serial]
fn it_processes_sse_usage_event_across_chunks_until_done() {
    ...
    module
        ...
        .expect_log(
            ...
            Some(
                format!(
                    "#2 handle_sse_stream: body_size: {}, end_of_stream: false, sse_offset: {}",
                    usage_chunk.len(), 0
                )
                .as_str(),
            ),
    ...
    module
        ...
        .expect_log(
            Some(LogLevel::Debug),
            Some("#2 handle_sse_stream: processing chunk: data: [DONE]\n\n"),
        )
        .execute_and_expect(ReturnType::Action(Action::Pause))
        .unwrap();
    ...
    module
        ...
        .expect_log(
            ...
            Some(
                format!(
                    "#2 handle_sse_stream: body_size: {}, end_of_stream: true, sse_offset: {}",
                    total_len, total_len
                )
                .as_str(),
            ),
