    ...
    module
        ...
        .expect_grpc_call(
            ...
            Some(&[
                ...
                97, 117, 116, 104, 111, 114, 105, 110, 111, 45, 99, 108, 117, 115, 116, 101, 114, 0 // "authorino-cluster" + NUL
            ]),
            None,
            Some(5000),
        )
...
fn it_passes_request_data() {
    ...
    module
        ...
        .expect_log(
            Some(LogLevel::Debug),
            Some("get_property: path: [\"filter_state\", \"wasm.kuadrant.auth.identity.name\"]")
        )
