use crate::metrics::{WasmMetricsReporter, METRICS};
use crate::wasm_host::ProxyWasmHost;
...
impl KuadrantFilter {
    ...
    fn new_ctx(&self) -> ReqRespCtx {
        ReqRespCtx::new(Arc::new(ProxyWasmHost)).with_metrics(Arc::new(WasmMetricsReporter))
    }
}
